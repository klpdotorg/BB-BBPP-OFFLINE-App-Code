...
Game.appLoginEditScreenbbpp.prototype = {
	...
	create: function (game) {
		...
		_this.basePath = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffKan/Files/Download/.gameFilesBB++V10_2/www/";

		//* nEED to change this ****
		_this.fullSize = 307651189;

		_this.zipFiles = [["Assets1.zip", 981561], ["Assets2.zip", 87798759], ["Assets4.zip", 95186236], ["KannadaquestionSounds.zip", 119941833], ["sounds.zip", 3742800]];

		// _this.zipFiles = [["Assets1.zip", 981561], ["Assets2.zip", 87798759], ["Assets4.zip", 95186236], ["EnglishquestionSounds.zip", 103080138], ["HindiquestionSounds.zip", 119374649],
		// ["KANquestionSounds.zip", 119941833], ["OdiyaquestionSounds.zip", 127903659], ["MarathiquestionSounds.zip", 136781929], ["TamilquestionSounds.zip", 103175062], ["sounds.zip", 3742800]];
		...
		if (_this.language == "English") {
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/English", _this.language + "/EnglishquestionSounds.zip"],//ENG
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
				// [_this.basePath + "assets/gradeSelectionScreenAssets", _this.user ) + "/Assets5.zip"],
				[_this.basePath + "sounds", "sounds.zip"]
			];
		}
		else if (_this.language == "Hindi") {
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/Hindi", _this.language + "/HindiquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/Kannada", _this.language + "/KannadaquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/Odiya", _this.language + "/OdiyaquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// else if(_this.user == "Gujarati")
		// {

		// }
		else if (_this.language == "Marathi") {
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/Marathi", _this.language + "/MarathiquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// else if(_this.user == "Telugu")
		// {

		// }
		else if (_this.language == "Tamil") {
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/Tamil", _this.language + "/TamilquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// 	_this.state.start('appLoginScreenbbpp', true, false, _this.app_Mode, _this.user);
		// }, _this);
		...
		var welcome = welcomeTextMap[_this.language && _this.language] || welcomeTextMap.Kannada;
			...
			if (
				...
				$.ajax({
					...
					success: function (jsonresp) {
						console.log(jsonresp);
						if (jsonresp.status == "success") {
							bbregloginbbpp.bbdbhandler.executeSql(
								"insert into user(uid, name, language, deviceId, grade) values (?,?,?,?,?)",
								[acc_token, jsonresp.name, jsonresp.language, jsonresp.deviceid, (jsonresp.grade || '6th Grade')],
								null, null
							);
	...
	fileChecker: function (filepath, filename) {
		window.resolveLocalFileSystemURL(filepath,
			function (fileEntry) {
				...
				console.log("file not present:download" + filename, "error", error);
	...
	checkIfAllAssetsPresent: function () {
		if (_this.counter < _this.fileCheck.length) {
			...
			window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffKan/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 
	...
	downloadFiles: function (filename) {
		...
		if (navigator.connection.type != "none" && navigator.connection.type != "unknown" && navigator.connection.type != null && navigator.connection.type != "undefined") {
			...
			fileTransfer.onprogress = function (progressEvent) {
				...
				if (progressEvent.lengthComputable) {
					...
					if (filename != "EnglishquestionSounds.zip" && filename != "HindiquestionSounds.zip" && filename != "KannadaquestionSounds.zip" && filename != "OdiyaquestionSounds.zip" &&
						...
						if (filename == _this.language + "/KannadaquestionSounds.zip") {
							console.log("QSound");
			...
			console.log(_this.basePath + filename, "_this.basePath + filename");
