Game.NSF_3_G6demo = function () {};

Game.NSF_3_G6demo.prototype = 
{
...
//*************************************************************************************************
        ...
        if (_this.languageSelected == null 
            ...
            || _this.languageSelected == "")
        {
            _this.languageSelected = "Marathi";
        }
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl+"questionSounds/NSF-3-G6/" + 
                                         _this.languageSelected + "/NSF-3-G6.mp3");
    ...
    {       
        ...
        this.load.video('nsf3',window.baseUrl+'assets/demoVideos/NSF-3-G6.mp4');
//        this.load.atlas('backbtn','assets/commonAssets/backbtn.png','assets/commonAssets/bkbtn.json');
    ...
    {        
        ...
        _this.skip.events.onInputDown.add(function ()
        {
           ...
           // _this.stopVideo();
            _this.stopAudio();
            _this.state.start('NSF_3_G6level1');
        });
    },
    ...
    {
        _this.q1Sound.play(); 
        _this.demoVideo_1 = _this.add.video('nsf3');
                
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl+"assets/demoVideos/NSF-3-G6.mp4");
