...
Game.appLoginEditScreenbbpp.prototype = {
	...
	create: function (game) {
		...
		//* nEED to change this ****
		_this.fullSize = 315613015;

		_this.zipFiles = [["Assets1.zip", 981561], ["Assets2.zip", 87798759], ["Assets4.zip", 95186236], ["OdiyaquestionSounds.zip", 127903659], ["sounds.zip", 3742800]];
		...
		var welcome = welcomeTextMap[_this.language && _this.language] || welcomeTextMap.Odiya;
			...
			fileTransfer.onprogress = function (progressEvent) {
				...
				if (progressEvent.lengthComputable) {
					...
					if (filename != "EnglishquestionSounds.zip" && filename != "HindiquestionSounds.zip" && filename != "KannadaquestionSounds.zip" && filename != "OdiyaquestionSounds.zip" &&
						...
						if (filename == _this.language + "/OdiyaquestionSounds.zip") {
							console.log("QSound");
