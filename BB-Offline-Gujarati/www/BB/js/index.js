...
var app = {
  ...
  create: function (game) {
    ...
    if (this.app_Mode == "offline") {
      window.languageSelected = "Gujarati"; //* Set this variable based on the language you need to generate - Offline
    }
    ...
    this.app_Grade = "offline"; //online//* Set to to offline if you want to generate offline app
